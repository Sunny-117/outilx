...
describe('getConfigFromDataSource', () => {
    it('should return correct mappings for provided data source', () => {
        ...
        expect(result.nameMapByValue).toEqual({ 1: '文案A', 2: '文案B', 3: '文案C' });
    ...
    it('should throw an error for duplicate keys', () => {
        ...
        expect(() => getConfigFromDataSource(dataSource)).toThrowError('Duplicate key "A" found in dataSource.');
    });
    ...
    it('should throw an error for duplicate values', () => {
        ...
        expect(() => getConfigFromDataSource(dataSource)).toThrowError('Duplicate value "1" found in dataSource.');
    });
});
